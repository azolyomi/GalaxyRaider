...
function staffleaderboard(msg, args) {
    if (!CONFIG.SystemConfig.servers[msg.guildID]) return "You first have to configurate the server. Type \`.instructions\` for help.";

    let type = "runpoints";
    let acceptableTypes = ["void", "cult", "shatters", "nest", "fungal", "steamworks", "o3", "misc", "currentCycle"];
    if (args[0] && acceptableTypes.includes(args[0])) type = args[0];
...
exports.staffleaderboard = staffleaderboard;