...
function registerKeyPopperRole(msg, args) {
    ...
    return `Successfully set the \`${inputtype}\` tier key popper role to the role <@&${roleID}>, with a point value of ${pointvalue}`;
...
**Usage**: \`${CONSTANTS.botPrefix}registerkeypopperrole <tier> <pointvalue> <@role>\`
